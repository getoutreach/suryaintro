...
// suryaintro API defined in api/suryaintro.proto. The concrete implementation
...
import (
	...
	"github.com/getoutreach/suryaintro/internal/lifecycle"
...
func (gs *GRPCService) StartServers(ctx context.Context, servers *Servers, opts ...grpcx.ServerOption) (*grpc.Server, error) {
	...
	api.RegisterSuryaintroServer(s, rpcserver{servers.DefaultServer})
