...
// MODIFY THE suryaintro.override.jsonnet INSTEAD
  ...
  e2e_svc_account: ok.ServiceAccount('%s-e2e-client-svc' % app.name, app.namespace) {
    metadata+: {
      annotations+: {
        ...
        'outreach.io/authn-v1-audience-ids': 'orgservice@outreach.cloud tollmon@outreach.cloud orgapi@outreach.cloud suryaintro@outreach.cloud flagship@outreach.cloud flagship-internal@outreach.cloud',
