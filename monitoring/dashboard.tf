...
# https://app.datadoghq.com/metric/summary?metric=suryaintro.grpc_request_handled
...
locals {
  standard_links = [
    "[GitHub](https://github.com/getoutreach/suryaintro)",
    "[Engdocs](https://engdocs.outreach.cloud/github.com/getoutreach/suryaintro)",
    "[Logs](https://app.datadoghq.com/logs?cols=service%2C%40bento%2Csource&from_ts=1601507372082&index=main&live=true&messageDisplay=expanded-md&stream_sort=desc&to_ts=1601508272082&query=service%3Asuryaintro)",
    "[Honeycomb](https://ui.honeycomb.io/outreach-a0/datasets/outreach?query=%7B%22breakdowns%22%3A%5B%22service_name%22%2C%22name%22%2C%22deployment.bento%22%5D%2C%22calculations%22%3A%5B%7B%22op%22%3A%22COUNT%22%7D%2C%7B%22column%22%3A%22duration_ms%22%2C%22op%22%3A%22P90%22%7D%2C%7B%22column%22%3A%22duration_ms%22%2C%22op%22%3A%22HEATMAP%22%7D%5D%2C%22filters%22%3A%5B%7B%22column%22%3A%22service_name%22%2C%22op%22%3A%22exists%22%2C%22join_column%22%3A%22%22%7D%2C%7B%22column%22%3A%22service_name%22%2C%22op%22%3A%22%3D%22%2C%22value%22%3A%22suryaintro%22%2C%22join_column%22%3A%22%22%7D%5D%2C%22orders%22%3A%5B%7B%22op%22%3A%22COUNT%22%2C%22order%22%3A%22descending%22%7D%5D%2C%22limit%22%3A1000%2C%22time_range%22%3A604800%7D)",
    "[Owning GitHub team](https://github.com/orgs/getoutreach/teams/cad-fri)",
...
module "description_note" {
  ...
  content = <<-EOF
    ...
    This is the terraform-managed dashboard for the suryaintro service.
  EOF
}

locals {
  header_section = {
    name = "Suryaintro Service Info"
    charts = [
...
#   deployment = "suryaintro"
#   call       = "api.suryaintro.pongrequest"
# }
#
...
module "dashboard" {
  ...
  name        = "Terraform: Suryaintro"
  description = "Managed by terraform in github.com/getoutreach/suryaintro"

  tags       = ["team:${var.dd_team_tag}"]
